...
# Create txchangecoin user
RUN adduser --system --group --disabled-password txchangecoin && \
	mkdir -p /wallet /home/txchangecoin/.txchangecoin && \
	chown -R txchangecoin:txchangecoin /home/txchangecoin/.txchangecoin && \
	chown -R txchangecoin:txchangecoin /wallet

# Contains the blockchain
VOLUME /home/txchangecoin/.txchangecoin
...
# switch to user txchangecoin
USER txchangecoin

ENTRYPOINT ["txchangecoind", "--p2p-bind-ip=0.0.0.0", "--p2p-bind-port=38380", "--rpc-bind-ip=0.0.0.0", "--rpc-bind-port=38381", "--non-interactive", "--confirm-external-bind"]
